"""
Django settings for prd_ai_loom_45682 project.
...
ROOT_URLCONF = 'prd_ai_loom_45682.urls'
...
WSGI_APPLICATION = 'prd_ai_loom_45682.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_ai_loom_45682 API",
    "DESCRIPTION": "API documentation for prd_ai_loom_45682 App",
    "VERSION": "v1",
}
